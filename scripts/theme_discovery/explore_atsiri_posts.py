...
THEME_RULES = [
    ...
    ThemeRule(
        ...
        ["tawangmangu", "karanganyar", "plumbon", "wonderfulindonesia", "visitindonesia"],
        ["wisata", "berkunjung", "visit", "destination", "travel", "tawangmangu", "karanganyar"],
        "Muncul dari penanda lokasi/wisata seperti Tawangmangu, Karanganyar, dan visit Indonesia.",
        "Dipertahankan dengan definisi sempit sebagai framing destinasi/kunjungan, bukan sekadar semua post tentang tempat.",
    ),
    ThemeRule(
        "event_campaign",
    ...
    ThemeRule(
        ...
        ["rumahatsiriarchitecture", "rumahatsirilandscape"],
        ["architecture", "landscape", "design", "plaza", "space"],
        "Muncul dari hashtag architecture/landscape dan beberapa kata desain ruang.",
        "Tidak dipakai sebagai tema mandiri; digabung ke destination_tourism karena count kecil dan overlap tinggi.",
    ),
]
